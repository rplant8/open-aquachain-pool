...
func (r *RPCClient) GetWork() ([]string, error) {
	rpcResp, err := r.doPost(r.Url, "aqua_getWork", []string{})
	if err != nil {
		return nil, err
	}
	var reply []string
...
func (r *RPCClient) GetPendingBlock() (*GetBlockReplyPart, error) {
	rpcResp, err := r.doPost(r.Url, "aqua_getBlockByNumber", []interface{}{"pending", false})
	if err != nil {
		return nil, err
	}
...
func (r *RPCClient) GetBlockByHeight(height int64) (*GetBlockReply, error) {
	...
	return r.getBlockBy("aqua_getBlockByNumber", params)
}

func (r *RPCClient) GetBlockByHash(hash string) (*GetBlockReply, error) {
	params := []interface{}{hash, true}
	return r.getBlockBy("aqua_getBlockByHash", params)
}
...
func (r *RPCClient) GetUncleByBlockNumberAndIndex(height int64, index int) (*GetBlockReply, error) {
	...
	return r.getBlockBy("aqua_getUncleByBlockNumberAndIndex", params)
}
...
func (r *RPCClient) GetTxReceipt(hash string) (*TxReceipt, error) {
	rpcResp, err := r.doPost(r.Url, "aqua_getTransactionReceipt", []string{hash})
	if err != nil {
		return nil, err
	}
	if rpcResp.Result != nil {
...
func (r *RPCClient) GetBalance(address string) (*big.Int, error) {
	rpcResp, err := r.doPost(r.Url, "aqua_getBalance", []string{address, "latest"})
	if err != nil {
		return nil, err
	}
	var reply string
...
func (r *RPCClient) Sign(from string, s string) (string, error) {
	...
	rpcResp, err := r.doPost(r.Url, "aqua_sign", []string{from, common.ToHex(hash[:])})
	var reply string
	if err != nil {
		return reply, err
	}
...
func (r *RPCClient) SendTransaction(from, to, gas, gasPrice, value string, autoGas bool) (string, error) {
	...
	rpcResp, err := r.doPost(r.Url, "aqua_sendTransaction", []interface{}{params})
	var reply string
	if err != nil {
		return reply, err
	}
