...
/* Aquachain does not provide consistent state when you need both new height and new job,
 ...
 * ISSUE: https://github.com/aquanetwork/aquachain/issues/2333
 */
...
func matchCandidate(block *rpc.GetBlockReply, candidate *storage.BlockData) bool {
	...
	// Aquachain-style candidate matching
