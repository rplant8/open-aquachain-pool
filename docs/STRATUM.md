...
```javascript
{ "id": 1, "jsonrpc": "2.0", "method": "aqua_getWork" }
```
...
`aqua_submitHashrate` is a nonsense method. Pool ignores it and the reply is always:
