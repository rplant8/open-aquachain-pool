...
If your payout is not logged and not confirmed by Aquachain network you can resolve it automatically. You need to payouts in maintenance mode by setting up `RESOLVE_PAYOUT=1` or `RESOLVE_PAYOUT=True` environment variable:

`RESOLVE_PAYOUT=1 ./build/bin/open-aquachain-pool payouts.json`.

Payout module will fetch all rows from Redis with key `aqua:payments:pending` and credit balance back to miners. Usually you will have only single entry there.
...
You can perform manual maintenance using `aquachain` and `redis-cli` utilities.
...
```
ZREVRANGE "aqua:payments:pending" 0 -1 WITHSCORES
```
...
```
ZADD "aqua:payments:all" 1462920526 0xe670ec64341771606e55d6b4ca35a1a6b75ee3d5145a99d05921026d1527331:0xb85150eb365e7df0941f0cf08235f987ba91506a:25000000
```

```
ZADD "aqua:payments:0xb85150eb365e7df0941f0cf08235f987ba91506a" 1462920526 0xe670ec64341771606e55d6b4ca35a1a6b75ee3d5145a99d05921026d1527331:25000000
```

### Delete Erroneous Payment Entry

```
ZREM "aqua:payments:pending" "0xb85150eb365e7df0941f0cf08235f987ba91506a:25000000"
```

### Update Internal Stats

```
HINCRBY "aqua:finances" pending -25000000
HINCRBY "aqua:finances" paid 25000000
```

### Unlock Payouts

```
DEL "aqua:payments:lock"
```
